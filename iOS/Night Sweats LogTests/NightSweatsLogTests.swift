import XCTest
@testable import NightSweatsLog

@MainActor
final class NightSweatsLogTests: XCTestCase {
    ...
    func testUpdateReplacesItem() {
        ...
        first.possibleCause = "Updated Name"
        store.update(first)
        XCTAssertEqual(store.items.first?.possibleCause, "Updated Name")
    }
