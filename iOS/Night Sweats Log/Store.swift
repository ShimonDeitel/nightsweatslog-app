...
final class Store: ObservableObject {
    ...
    init() {
        ...
        fileURL = support.appendingPathComponent("nightsweatslog_items.json")
        load()
    }
    ...
    private func seedData() -> [EntryItem] {
        [
        EntryItem(possibleCause: "Stress", severity: "3", roomTemp: "72", notes: "Woke up twice."),
        EntryItem(possibleCause: "Hot room", severity: "2", roomTemp: "78", notes: "Forgot to turn on fan.")
        ]
    }
}
